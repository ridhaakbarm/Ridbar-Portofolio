...
- `/about`
- `/projects`
- `/projects/cmb-manufacturing-execution`
- `/projects/oee-production-monitoring`
- `/projects/k-maint-maintenance-workflow`
- `/projects/lab-dispatch-qc-queue`
- `/projects/production-daily-reporting`
- `/projects/autonomous-maintenance-daily-check`
- `/projects/color-change-cleaning-workflow`
- `/projects/mixing-method-production-input`
- `/resume`
- `/contact`
